...
class RangeSensorLayer : public layered_costmap_2d::CostmapLayer
{
public:
...
private:
    ...
    double to_prob(unsigned char c){ return double(c)/layered_costmap_2d::LETHAL_OBSTACLE; }
    unsigned char to_cost(double p){ return (unsigned char)(p*layered_costmap_2d::LETHAL_OBSTACLE); }
